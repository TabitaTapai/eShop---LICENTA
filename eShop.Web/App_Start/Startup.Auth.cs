...
using eShop.Web.Areas.API.Providers;
...
namespace eShop.Web
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(eShopContext.Create);
            app.CreatePerOwinContext<eShopUserManager>(eShopUserManager.Create);
            app.CreatePerOwinContext<eShopSignInManager>(eShopSignInManager.Create);
            app.CreatePerOwinContext<eShopRoleManager>(eShopRoleManager.Create);
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                Provider = new CookieAuthenticationProvider
                {
                    ...
                    OnValidateIdentity = SecurityStampValidator.OnValidateIdentity<eShopUserManager, eShopUser>(
            ...
            OAuthOptions = new OAuthAuthorizationServerOptions
            {
                ...
                Provider = new eShopOAuthProvider(),
