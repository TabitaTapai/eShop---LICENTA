    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/bundles/content/css").NonOrdering().Include(
                      ...
                      "~/content/templates/css/owl.carousel.min.css",
                      "~/content/templates/css/nice-select.css",
                      "~/content/lib/jquery-ui-1.12.1/jquery-ui.min.css",
                      "~/content/templates/css/slicknav.min.css",
                      "~/content/templates/css/style.css",
            ...
            bundles.Add(new ScriptBundle("~/bundles/content/fscripts").NonOrdering().Include(
                        ...
                        "~/content/templates/js/jquery.nice-select.min.js",
                        "~/content/templates/js/jquery.zoom.min.js",
                        "~/content/lib/ms-dropdown-3.5.2/jquery.dd.min.js",
                        "~/content/templates/js/jquery.slicknav.js",
                        "~/content/templates/js/owl.carousel.min.js",
                        "~/content/templates/js/main.js"));
            ...
            bundles.Add(new StyleBundle("~/bundles/content/rtl/css").NonOrdering().Include(
                      ...
                      "~/content/lib/jquery-ui-1.12.1/jquery-ui.min.css",
                      "~/content/templates/css/slicknav.min.css",
                      "~/content/templates/css/style.rtl.css",
                      "~/content/css/site.css"));
