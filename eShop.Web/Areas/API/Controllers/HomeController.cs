...
using eShop.Web.Areas.API.Models;
using System;
...
namespace eShop.Web.Areas.API.Controllers
{
    public class HomeController : APIBaseController
    {
            ...
            if(SlidersConfigurations != null && SlidersConfigurations.Count > 0)
            {
                foreach (var sliderConfig in SlidersConfigurations)
                {
                    ...
                    sliders.Add(new Slider() {
                        ImageLink = string.Format("{0}{1}", eShopConstants.MAIN_IMAGES_DIRECTORY, img),
                        Heading = topHeading,
                        Summary = paragraph,
                        Link = link
                    });
        ...
        [HttpGet]
        public IHttpActionResult FeaturedCategories(int? recordSize = 4)
        {
            ...
            if (categories != null && categories.Count > 0)
            {
                foreach (var category in categories)
                {
                    ...
                    featuredCategories.Add(new CategoryEntity()
                    {
                        ...
                        Picture = category.Picture != null ? string.Format("{0}{1}", eShopConstants.MAIN_IMAGES_DIRECTORY, category.Picture.URL) : string.Empty,
            ...
            if (categories != null && categories.Count > 0)
            {
                ...
                foreach (var topCategory in categories.Where(x=>!x.ParentCategoryID.HasValue))
                {
                    ...
                    if(childCategories != null && childCategories.Count > 0)
                    {
                        foreach (var childCategory in childCategories)
                        {
                            ...
                            childrenMenu.Add(new MenuCategory()
                            {
                                ...
                                Picture = childCategory.Picture != null ? string.Format("{0}{1}", eShopConstants.MAIN_IMAGES_DIRECTORY, childCategory.Picture.URL) : string.Empty,
                    ...
                    menuCategories.Add(new MenuCategory()
                    {
                        ...
                        Picture = topCategory.Picture != null ? string.Format("{0}{1}", eShopConstants.MAIN_IMAGES_DIRECTORY, topCategory.Picture.URL) : string.Empty,
        ...
        [HttpGet]
        public IHttpActionResult FeaturedProducts(int? recordSize = 4)
        {
            ...
            if(featuredProducts != null && featuredProducts.Count > 0)
            {
                ...
                foreach (var product in featuredProducts)
                {
                    ...
                    productsList.Add(new ProductEntity()
                    {
                        ...
                        Pictures = product.ProductPictures != null ? product.ProductPictures.Where(x => x.Picture != null).Select(x => new PictureEntity() { URL = string.Format("{0}{1}", eShopConstants.MAIN_IMAGES_DIRECTORY, x.Picture.URL), IsThumbnail = product.ThumbnailPictureID == x.PictureID }).ToList() : new List<PictureEntity>() { new PictureEntity() { URL = string.Format("{0}{1}", eShopConstants.MAIN_IMAGES_DIRECTORY, eShopConstants.DEFAULT_PICTURE), IsThumbnail = true } }
                    });
                }
            ...
            if(relatedProducts != null && relatedProducts.Count > 0)
            {
                foreach (var relatedProduct in relatedProducts)
                {
                    ...
                    productList.Add(new ProductEntity()
                    {
                        ...
                        ProductSpecifications = currentLanguageProductRecord.ProductSpecifications != null ? currentLanguageProductRecord.ProductSpecifications.Select(x => new ProductSpecificationEntity() { Title = x.Title, Value = x.Value }).ToList() : new List<ProductSpecificationEntity>(),
                        Pictures = relatedProduct.ProductPictures != null ? relatedProduct.ProductPictures.Where(x => x.Picture != null).Select(x => new PictureEntity() { URL = string.Format("{0}{1}", eShopConstants.MAIN_IMAGES_DIRECTORY, x.Picture.URL), IsThumbnail = relatedProduct.ThumbnailPictureID == x.PictureID }).ToList() : new List<PictureEntity>() { new PictureEntity() { URL = string.Format("{0}{1}", eShopConstants.MAIN_IMAGES_DIRECTORY, eShopConstants.DEFAULT_PICTURE), IsThumbnail = true } }
                    });
                }
            }
