...
using eShop.Web.Areas.API.Commons.Extensions;
...
namespace eShop.Web.Areas.API.Controllers
{
    ...
    public class UsersController : APIBaseController
    {
        ...
        public UsersController(eShopUserManager userManager, ISecureDataFormat<AuthenticationTicket> accessTokenFormat)
        {
        ...
        public async Task<IHttpActionResult> UpdateUserAvatar()
        {
            ...
            if (pictures.Count > 0)
            {
                ...
                var path = HttpContext.Current.Server.MapPath(string.Format("~{0}", eShopConstants.MAIN_IMAGES_DIRECTORY)) + fileName;
